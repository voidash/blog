...
This is such a convincing answer to the question i had previous week, regarding where all this non-determinism in the world is coming from. But still **ontological randomness** has been hurting me. Randomness as the very nature of things is weird. I have convinced myself with chaos theory. It is study of how small changes in initial conditions leads to whole different patterns later on. Perhaps, we can never record all the dynamics of the system. Initial or any conditions can never be fully grasped. Measurement has moved itself from the platinum-iridium in Paris to something concrete like using planck's constant. i.e $hv=mc^2$. But still you are just moving the problem. I have yet to look into quantum mechanics and I have little to no knowledge regarding it but randomness as ontology seems to arise from there. Thanks Heisenberg...
